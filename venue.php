    				...
    				<div class="row">
		    			<div class="col-sm-12 col-md-12 col-lg-4 ftco-animate d-flex">
		    				<div class="product d-flex flex-column">
		    					<a href="venue1.php" class="img-prod"><img class="img-fluid" src="images/ven1.jpg" alt="Colorlib Template">
		    					...
		    					<div class="text py-3 pb-4 px-3">
		    						...
		    						<h3><a href="venue1.php">SHENA KUNJO</a></h3>
		    						<div class="pricing">
                      ...
                      <p class="price"><span>Generator available 24/7 </span></p>
			    					...
			    					<p class="bottom-area d-flex px-3">
		    							<a href="venue1.php" class="add-to-cart text-center py-2 mr-1"><span>Select <i class="ion-ios-add ml-1"></i></span></a>
		    			...
		    			<div class="col-sm-12 col-md-12 col-lg-4 ftco-animate d-flex">
		    				<div class="product">
		    					<a href="venue2.php" class="img-prod"><img class="img-fluid" src="images/venu2.jpg" alt="Colorlib Template">
			    					<div class="overlay"></div>
			    				</a>
		    					<div class="text py-3 pb-4 px-3">
		    						<div class="d-flex">
		    						...
		    						<h3><a href="venue2.php">SHENA MALONCHO</a></h3>
		  							<div class="pricing">
                      ...
                      <p class="price"><span>Generator available 24/7</span></p>
			    					...
			    					<p class="bottom-area d-flex px-3">
		    							<a href="venue2.php" class="add-to-cart text-center py-2 mr-1"><span>Select <i class="ion-ios-add ml-1"></i></span></a>
		    							<!--<a href="#" class="buy-now text-center py-2">Buy now<span><i class="ion-ios-cart ml-1"></i></span></a>-->
		    						</p>
		    					</div>
		    				</div>
		    			...
		    			<div class="col-sm-12 col-md-12 col-lg-4 ftco-animate d-flex">
		    				<div class="product">
		    					<a href="venue3.php" class="img-prod"><img class="img-fluid" src="images/venu3.jpg" alt="Colorlib Template">
		    						<div class="overlay"></div>
		    					</a>
		    					<div class="text py-3 pb-4 px-3">
		    						<div class="d-flex">
		    						...
		    						<h3><a href="venue3.php">Officers' Club</a></h3>
		  							<div class="pricing">
                      ...
                      <p class="price"><span>Generator available only in night</span></p>
			    					...
			    					<p class="bottom-area d-flex px-3">
		    							<a href="venue3.php" class="add-to-cart text-center py-2 mr-1"><span>Select <i class="ion-ios-add ml-1"></i></span></a>
		    							<!--<a href="#" class="buy-now text-center py-2">Buy now<span><i class="ion-ios-cart ml-1"></i></span></a>-->
		    						</p>
		    					</div>
		    				</div>
