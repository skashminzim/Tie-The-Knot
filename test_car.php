...
$query = 'SELECT customer.customer_name,event_id,car.package_cost,car.hour_needed,car.total_cost FROM customer NATURAL JOIN choose NATURAL JOIN car where customer_id=158';
