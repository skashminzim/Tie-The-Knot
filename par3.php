...
<html>
<head><title>Parlour|Tie the Knot</title></head>
<style>
h1 {
  color:#6C3483 ;
...
$conn = oci_connect("31PROJECT", "31project","localhost/XE");
...
$stid = oci_parse($conn, 'INSERT INTO parlour(event_id ,package_cost ) VALUES(eve_id_seq.nextval, :mydata )');
