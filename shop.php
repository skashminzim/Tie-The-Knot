...
<html lang="en">
  <head>
    <title>Photography | Tie the Knot</title>
    <meta charset="utf-8">
    		...
    		<div class="row">
    			<div class="col-md-8 col-lg-10 order-md-last">
    				<div class="row">
		    				...
		    				<div class="product d-flex flex-column">
		    					...
		    					<div class="text py-3 pb-4 px-3">
			    					...
			    					<p class="bottom-area d-flex px-3">
		    							<a href="photo_p1.php" class="add-to-cart text-center py-2 mr-1"><span>Select <i class="ion-ios-add ml-1"></i></span></a>
		    			...
		    			<div class="col-sm-12 col-md-12 col-lg-4 ftco-animate d-flex">
		    				<div class="product d-flex flex-column">
		    					<a href="login.php" class="img-prod"><img class="img-fluid" src="images/weddingdiary.jpg" alt="Colorlib Template">
		    					...
		    					<div class="text py-3 pb-4 px-3">
			    					...
			    					<p class="bottom-area d-flex px-3">
		    							<a href="photo_p2.php" class="add-to-cart text-center py-2 mr-1"><span>Select <i class="ion-ios-add ml-1"></i></span></a>
		    							<!--<a href="#" class="buy-now text-center py-2">Buy now<span><i class="ion-ios-cart ml-1"></i></span></a>-->
		    						</p>
		    					</div>
		    				</div>
		    			...
		    			<div class="col-sm-12 col-md-12 col-lg-4 ftco-animate d-flex">
		    				<div class="product">
		    					<a href="#login.php" class="img-prod"><img class="img-fluid" src="images/nijol.png" alt="Colorlib Template">
			    					<div class="overlay"></div>
			    				</a>
		    					<div class="text py-3 pb-4 px-3">
		    						<div class="d-flex">
			    					...
			    					<p class="bottom-area d-flex px-3">
		    							<a href="photo_p3.php" class="add-to-cart text-center py-2 mr-1"><span>Select <i class="ion-ios-add ml-1"></i></span></a>
		    							<!--<a href="#" class="buy-now text-center py-2">Buy now<span><i class="ion-ios-cart ml-1"></i></span></a>-->
		    						</p>
		    					</div>
		    				</div>
