...
<html lang="en">
 ...
 <!-- <body class="goto-here">
    ...
    <div class="hero-wrap hero-bread" style="background-image: url('images/pt1.jpg');">
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center">
          <div class="col-md-9 ftco-animate text-center">
          	<!--<p class="breadcrumbs"><span class="mr-2"><a href="index.html">Home</a></span> <span>Shop</span></p>-->
            <h1 class="mb-0 bread">PARLOUR & MAKEOVER</h1>
          </div>
        </div>
      </div>
    </div>
    	...
    	<div class="container">
    		<div class="row">
    			<div class="col-md-8 col-lg-10 order-md-last">
    				<div class="row">
		    			<div class="col-sm-12 col-md-12 col-lg-4 ftco-animate d-flex">
		    				<div class="product d-flex flex-column">
		    					<a href="#" class="img-prod"><img class="img-fluid" src="images/pt4.jpg" alt="Colorlib Template">
                      ...
                      <p class="price"><span>Makeup</span></p>
                      <p class="price"><span>Saree Draping</span></p>
                      <p class="price"><span>Hair Styling </span></p>
                      <p class="price"><span>Hair Extension</span></p>
                      <p class="price"><span>False Lashes </span></p>
                      <p class="price"><span>Mehedi </span></p>
                      <p class="price"><span>Nail Polish </span></p>
		    			...
		    			<div class="col-sm-12 col-md-12 col-lg-4 ftco-animate d-flex">
		    				<div class="product">
		    					<a href="#" class="img-prod"><img class="img-fluid" src="images/pt2.jpg" alt="Colorlib Template">
			    					<div class="overlay"></div>
			    				</a>
		    					<div class="text py-3 pb-4 px-3">
		    						<div class="d-flex">
		    						...
		    						<h3><a href="#">Package 2 </a></h3>
		  							<div class="pricing">
                      <p class="price"><span>28,000 BDT</span></p>
                      <p class="price"><span>Makeup</span></p>
                      <p class="price"><span>Saree Draping</span></p>
                      <p class="price"><span>Hair Styling </span></p>
                      <p class="price"><span>False Lashes </span></p>
		    			...
		    			<div class="col-sm-12 col-md-12 col-lg-4 ftco-animate d-flex">
		    				<div class="product">
		    					<a href="#" class="img-prod"><img class="img-fluid" src="images/pt3.jpg" alt="Colorlib Template">
		    						<div class="overlay"></div>
		    					</a>
		    					<div class="text py-3 pb-4 px-3">
		    						<div class="d-flex">
                    ...
                    <div class="pricing">
                      <p class="price"><span>12,000 BDT</span></p>
                      <p class="price"><span>Makeup</span></p>
                      <p class="price"><span>Saree Draping</span></p>
