...
//car
$query = "select a.total_cost+b.total_cost+c.total_cost+d.total_cost+e.total_cost+f.total_cost+m.total_cost from Venue a, Photography b, Music_Dj c, car d , catering e, stage f, makeup m where customer_name='$name1'and password= '$pass1'";
$stid = oci_parse($conn, $query);
$r = oci_execute($stid);
// Fetch each row in an associative array
//echo "Car cost : ";
