...
<html lang="en">
 ...
 <!-- <body class="goto-here">
	    ...
	    <div class="container">
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav ml-auto">
              ...
              <div class="dropdown-menu" aria-labelledby="dropdown04">
              	<a class="dropdown-item" href="signup_shop.php">Customer</a>
    ...
    <div class="hero-wrap hero-bread" style="background-image: url('images/photo25.jpg');">
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center">
          <div class="col-md-9 ftco-animate text-center">
          	<!--<p class="breadcrumbs"><span class="mr-2"><a href="index.php">Home</a></span> <span>Shop</span></p>-->
            <h1 class="mb-0 bread">Photography</h1>
          </div>
        </div>
      </div>
    </div>
    				...
    				<div class="row">
		    			<div class="col-sm-12 col-md-12 col-lg-4 ftco-animate d-flex">
		    				<div class="product d-flex flex-column">
		    					<a href="#" class="img-prod"><img class="img-fluid" src="images/weaver.jpg" alt="Colorlib Template">
		    					...
		    					<div class="text py-3 pb-4 px-3">
		    						...
		    						<h3><a href="photo_p1.php">Dream Weaver</a></h3>

									<p <span>2 Core Photographers. 1 senior photographer, 1 Chief Cinematographer,1 Senior Cinematographer,Will be providing all soft copies with all special edited photos.</span></p>
		    						<div class="pricing">
			    						<p class="price"><span>15000 tk</span></p>
			    					</div>
			    					<p class="bottom-area d-flex px-3">
		    							<a href="login_shop.php" class="add-to-cart text-center py-2 mr-1"><span>Select <i class="ion-ios-add ml-1"></i></span></a>
		    			...
		    			<div class="col-sm-12 col-md-12 col-lg-4 ftco-animate d-flex">
		    				<div class="product d-flex flex-column">
		    					<a href="login_shop.php" class="img-prod"><img class="img-fluid" src="images/weddingdiary.jpg" alt="Colorlib Template">
		    					...
		    					<div class="text py-3 pb-4 px-3">
		    						...
		    						<h3><a href="photo_p2.php">Wedding Diary</a></h3>
									<p <span>1 top photographer & 1 Assistant Photographer ( 2 Camera) Lighting System: Flash, Umbrella (Portrait light set up)</span></p>

		  							<div class="pricing">
			    						<p class="price"><span class="mr-2 price-dc"></span><span class="price-sale">10000 tk</span></p>
			    					</div>
			    					<p class="bottom-area d-flex px-3">
		    							<a href="login_shop.php" class="add-to-cart text-center py-2 mr-1"><span>Select <i class="ion-ios-add ml-1"></i></span></a>
		    							<!--<a href="#" class="buy-now text-center py-2">Buy now<span><i class="ion-ios-cart ml-1"></i></span></a>-->
		    			...
		    			<div class="col-sm-12 col-md-12 col-lg-4 ftco-animate d-flex">
		    				<div class="product">
		    					<a href="login_shop.php" class="img-prod"><img class="img-fluid" src="images/nijol.png" alt="Colorlib Template">
			    					<div class="overlay"></div>
			    				</a>
		    					<div class="text py-3 pb-4 px-3">
		    						<div class="d-flex">
		    						...
		    						<h3><a href="photo_p3.php">Nijol Creative Photography</a></h3>
									<p <span>1 Photographer # 4 Hours , All photos will be provided in DVD'S , Imported Photo Album Free</span></p>
		  							<div class="pricing">
			    						<p class="price"><span>5000 Tk</span></p>
			    					</div>
			    					<p class="bottom-area d-flex px-3">
		    							<a href="login_shop.php" class="add-to-cart text-center py-2 mr-1"><span>Select <i class="ion-ios-add ml-1"></i></span></a>
		    							<!--<a href="#" class="buy-now text-center py-2">Buy now<span><i class="ion-ios-cart ml-1"></i></span></a>-->
