    				...
    				<div class="row">
		    			<div class="col-sm-12 col-md-12 col-lg-4 ftco-animate d-flex">
		    				<div class="product d-flex flex-column">
		    					<a href="dj1.php" class="img-prod"><img class="img-fluid" src="images/live.jpg" alt="Colorlib Template">
		    					...
		    					<div class="text py-3 pb-4 px-3">
		    						...
		    						<h3><a href="dj1.php">Live Singer</a></h3>
		    						<div class="pricing">
			    						<p class="price"><span>5000 BDT/hour</span></p>
			    					</div>
			    					<p class="bottom-area d-flex px-3">
		    							<a href="dj1.php" class="add-to-cart text-center py-2 mr-1"><span>Select <i class="ion-ios-add ml-1"></i></span></a>
		    			...
		    			<div class="col-sm-12 col-md-12 col-lg-4 ftco-animate d-flex">
		    				<div class="product">
		    					<a href="dj2.php" class="img-prod"><img class="img-fluid" src="images/dj.jpg" alt="Colorlib Template">
			    					<div class="overlay"></div>
			    				</a>
		    					<div class="text py-3 pb-4 px-3">
		    						<div class="d-flex">
		    						...
		    						<h3><a href="dj2.php">DJ system</a></h3>
		  							<div class="pricing">
			    						<p class="price"><span>4000 BDT/hour</span></p>
			    					</div>
			    					<p class="bottom-area d-flex px-3">
		    							<a href="dj2.php" class="add-to-cart text-center py-2 mr-1"><span>Select <i class="ion-ios-add ml-1"></i></span></a>
		    							<!--<a href="#" class="buy-now text-center py-2">Buy now<span><i class="ion-ios-cart ml-1"></i></span></a>-->
		    						</p>
		    					</div>
		    				</div>
