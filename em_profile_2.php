 ...
 <!-- <body class="goto-here">
   ...
   <body>
     ...
     $conn = oci_connect("project", "project", "//localhost/orcl");
      ...
      $query = "SELECT * from employee where employee_id='$id'and employee_phone= '$pass'";
     $stid = oci_parse($conn, $query);
     $r = oci_execute($stid);

     // Fetch each row in an associative array
    $cars = array("ID : ", "NAME : ", "Address : ", "Phone no : ","Email id : ","Manager ID : ","Designation : ","Salary month : ","Salary : ","Salary Grade : ");
