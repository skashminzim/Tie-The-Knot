    				...
    				<div class="row">
		    			<div class="col-sm-12 col-md-12 col-lg-4 ftco-animate d-flex">
		    				<div class="product d-flex flex-column">
		    					<a href="par1.php" class="img-prod"><img class="img-fluid" src="images/pt4.jpg" alt="Colorlib Template">
                      ...
                      <p class="price"><span>Nail Polish </span></p>
			    					...
			    					<p class="bottom-area d-flex px-3">
		    							<a href="par1.php" class="add-to-cart text-center py-2 mr-1"><span>Select <i class="ion-ios-add ml-1"></i></span></a>
		    			...
		    			<div class="col-sm-12 col-md-12 col-lg-4 ftco-animate d-flex">
		    				<div class="product">
		    					<a href="par2.php" class="img-prod"><img class="img-fluid" src="images/pt2.jpg" alt="Colorlib Template">
			    					<div class="overlay"></div>
			    				</a>
		    					<div class="text py-3 pb-4 px-3">
		    						<div class="d-flex">
                      ...
                      <p class="price"><span>False Lashes </span></p>
                        <p class="price"><span>Nail Polish </span></p>
			    					...
			    					<p class="bottom-area d-flex px-3">
		    							<a href="par2.php" class="add-to-cart text-center py-2 mr-1"><span>Select <i class="ion-ios-add ml-1"></i></span></a>
		    							<!--<a href="#" class="buy-now text-center py-2">Buy now<span><i class="ion-ios-cart ml-1"></i></span></a>-->
		    						</p>
		    					</div>
		    				</div>
		    			...
		    			<div class="col-sm-12 col-md-12 col-lg-4 ftco-animate d-flex">
		    				<div class="product">
		    					<a href="par3.php" class="img-prod"><img class="img-fluid" src="images/pt3.jpg" alt="Colorlib Template">
		    						<div class="overlay"></div>
		    					</a>
		    					<div class="text py-3 pb-4 px-3">
		    						<div class="d-flex">
                    ...
                    <div class="pricing">
                      ...
                      <p class="price"><span>False Lashes </span></p>
                        <p class="price"><span>Nail Polish </span></p>
			    					...
			    					<p class="bottom-area d-flex px-3">
		    							<a href="par3.php" class="add-to-cart text-center py-2 mr-1"><span>Select <i class="ion-ios-add ml-1"></i></span></a>
		    							<!--<a href="#" class="buy-now text-center py-2">Buy now<span><i class="ion-ios-cart ml-1"></i></span></a>-->
		    						</p>
		    					</div>
		    				</div>
