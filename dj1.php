...
<html lang="en">
  <head>
    <title>DJ_MUSIC|Tie the knot</title>
    <meta charset="utf-8">
...
$stid = oci_parse($conn, 'INSERT INTO music_dj(event_id,expense_per_hour , hour_needed ) VALUES(eve_id_seq.nextval, :mydata, :hu)');
