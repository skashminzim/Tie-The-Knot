...
<html lang="en">
 ...
 <!-- <body class="goto-here">
    ...
    <div class="hero-wrap hero-bread" style="background-image: url('images/stg1.jpg');">
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center">
          <div class="col-md-9 ftco-animate text-center">
          	<!--<p class="breadcrumbs"><span class="mr-2"><a href="index.html">Home</a></span> <span>Shop</span></p>-->
            <h1 class="mb-0 bread">STAGE DECORATION</h1>
          </div>
        </div>
      </div>
    </div>
    	...
    	<div class="container">
    		<div class="row">
    			<div class="col-md-8 col-lg-10 order-md-last">
    				<div class="row">
		    			<div class="col-sm-12 col-md-12 col-lg-4 ftco-animate d-flex">
		    				<div class="product d-flex flex-column">
		    					<a href="#" class="img-prod"><img class="img-fluid" src="images/stg2.jpg" alt="Colorlib Template">
		    					...
		    					<div class="text py-3 pb-4 px-3">
		    						...
		    						<h3><a href="st1.php">Package 1</a></h3>
		    						<div class="pricing">
			    						<p class="price"><span>35,000 BDT</span></p>
                      <p class="price"><span>Customised furniture</span></p>
                      <p class="price"><span>Halogen light front and back</span></p>
                      <p class="price"><span>Customised Flower Decoration </span></p>
			    					</div>
			    					<p class="bottom-area d-flex px-3">
		    							<a href="st1.php" class="add-to-cart text-center py-2 mr-1"><span>Select <i class="ion-ios-add ml-1"></i></span></a>
		    			...
		    			<div class="col-sm-12 col-md-12 col-lg-4 ftco-animate d-flex">
		    				<div class="product">
		    					<a href="st2.php" class="img-prod"><img class="img-fluid" src="images/shena2.jpg" alt="Colorlib Template">
			    					<div class="overlay"></div>
			    				</a>
		    					<div class="text py-3 pb-4 px-3">
		    						<div class="d-flex">
		    						...
		    						<h3><a href="st2.php">Package 2 </a></h3>
		  							<div class="pricing">
                      <p class="price"><span>25,000 BDT</span></p>
                      <p class="price"><span>3 Piece furniture</span></p>
                      <p class="price"><span>Halogen light front </span></p>
                      <p class="price"><span>Customised Flower Decoration </span></p>
			    					</div>
			    					<p class="bottom-area d-flex px-3">
		    							<a href="st2.php" class="add-to-cart text-center py-2 mr-1"><span>Select <i class="ion-ios-add ml-1"></i></span></a>
		    							<!--<a href="#" class="buy-now text-center py-2">Buy now<span><i class="ion-ios-cart ml-1"></i></span></a>-->
		    						</p>
		    					</div>
		    				</div>
		    			...
		    			<div class="col-sm-12 col-md-12 col-lg-4 ftco-animate d-flex">
		    				<div class="product">
		    					<a href="st3.php" class="img-prod"><img class="img-fluid" src="images/shena3.jpg" alt="Colorlib Template">
		    						<div class="overlay"></div>
		    					</a>
		    					<div class="text py-3 pb-4 px-3">
		    						<div class="d-flex">
                    ...
                    <h3><a href="st3.php">Package 3 </a></h3>
                    <div class="pricing">
                      <p class="price"><span>15,000 BDT</span></p>
                      <p class="price"><span>3 Piece furniture</span></p>
                      <p class="price"><span>Halogen light front </span></p>
                      <p class="price"><span>Fixed Decoration Material </span></p>
			    					</div>
			    					<p class="bottom-area d-flex px-3">
		    							<a href="st3.php" class="add-to-cart text-center py-2 mr-1"><span>Select <i class="ion-ios-add ml-1"></i></span></a>
		    							<!--<a href="#" class="buy-now text-center py-2">Buy now<span><i class="ion-ios-cart ml-1"></i></span></a>-->
		    						</p>
		    					</div>
		    				</div>
