    		...
    		<div class="row">
    			<div class="col-md-8 col-lg-10 order-md-last">
    				<div class="row">
		    			<div class="col-sm-12 col-md-12 col-lg-4 ftco-animate d-flex">
		    				<div class="product d-flex flex-column">
		    					...
		    					<div class="text py-3 pb-4 px-3">
		    						...
		    						<h3><a href="cat1.php">1.Shahi Chicken Pulaao</a></h3>
									<h3><a href="cat1.php">2.Chicken Rezala</a></h3>
									<h3><a href="cat1.php">3.Shahi Jarda/Firni</a></h3>
									<h3><a href="cat1.php">4.Borhani/soft drinks</a></h3>
									
		    						<div class="pricing">
			    						<p class="price"><span>300 tk per plate</span></p>
			    					</div>
			    					<p class="bottom-area d-flex px-3">
		    							<a href="cat1.php" class="add-to-cart text-center py-2 mr-1"><span>Select <i class="ion-ios-add ml-1"></i></span></a>
		    			...
		    			<div class="col-sm-12 col-md-12 col-lg-4 ftco-animate d-flex">
		    				<div class="product">
		    					<a href="login.php" class="img-prod"><img class="img-fluid" src="images/chinese.jpg" alt="Colorlib Template">
			    					<div class="overlay"></div>
			    				</a>
		    					<div class="text py-3 pb-4 px-3">
		    						<div class="d-flex">
		    						...
		    						<h3><a href="cat2.php">1.Chicken Biriyani Garnished  With Egg </a></h3>
                                     <h3><a href="cat2.php">2.Mutton Kalia with Corriander </a></h3>
                                    <h3><a href="cat2.php">3.Chilli Fried Beef  </a></h3>
									 <h3><a href="cat2.php"> 4.Rashomalai/yogurt  </a></h3>
									 <h3><a href="cat1.php">5.Borhani/soft drinks</a></h3>
									 
		  							<div class="pricing">
			    						<p class="price"><span>650 Tk per plate</span></p>
			    					</div>
			    					<p class="bottom-area d-flex px-3">
		    							<a href="cat2.php" class="add-to-cart text-center py-2 mr-1"><span>Select <i class="ion-ios-add ml-1"></i></span></a>
		    							<!--<a href="#" class="buy-now text-center py-2">Buy now<span><i class="ion-ios-cart ml-1"></i></span></a>-->
		    						</p>
		    					</div>
		    				</div>
		    			...
		    			<div class="col-sm-12 col-md-12 col-lg-4 ftco-animate d-flex">
		    				<div class="product">
		    					<a href="login.php" class="img-prod"><img class="img-fluid" src="images/kacchi.jpg" alt="Colorlib Template">
		    						<div class="overlay"></div>
		    					</a>
		    					<div class="text py-3 pb-4 px-3">
		    						<div class="d-flex">
		    						...
		    						<h3><a href="cat3.php">1.Shahi Mutton Kacchi </a></h3>
									<h3><a href="cat3.php">2.Chicken Tandoori/Roast </a></h3>
									<h3><a href="cat3.php">3.Borhani/MIneral Water </a></h3>
									<h3><a href="cat3.php">4.Aloo Bokhra Chatni </a></h3>
									<h3><a href="cat1.php">5.Shahi Jarda/Firni</a></h3>
									<h3><a href="cat3.php"> </a></h3>
									<div class="pricing">
			    						<p class="price"><span>500 tk per plate</span></p>
			    					</div>
			    					<p class="bottom-area d-flex px-3">
		    							<a href="cat3.php" class="add-to-cart text-center py-2 mr-1"><span>Select <i class="ion-ios-add ml-1"></i></span></a>
		    							<!--<a href="#" class="buy-now text-center py-2">Buy now<span><i class="ion-ios-cart ml-1"></i></span></a>-->
		    						</p>
		    					</div>
		    				</div>
