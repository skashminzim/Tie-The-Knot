...
<html lang="en">
 ...
 <!-- <body class="goto-here">
    ...
    <div class="hero-wrap hero-bread" style="background-image: url('images/carr.jpg');">
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center">
          <div class="col-md-9 ftco-animate text-center">
          	<!--<p class="breadcrumbs"><span class="mr-2"><a href="index.html">Home</a></span> <span>Shop</span></p>-->
            <h1 class="mb-0 bread">Car</h1>
          </div>
        </div>
      </div>
    </div>
    				...
    				<div class="row">
		    			<div class="col-sm-12 col-md-12 col-lg-4 ftco-animate d-flex">
		    				<div class="product d-flex flex-column">
		    					<a href="c1.php" class="img-prod"><img class="img-fluid" src="images/car1.webp" alt="Colorlib Template">
		    					...
		    					<div class="text py-3 pb-4 px-3">
		    						...
		    						<h3><a href="c1.php"></a></h3>
		    						<div class="pricing">
			    						<p class="price"><span>4000Tk per hour</span></p>
										<p <span> Decorated with 200 Red Roses, 20 White & Red Balloons & Red Coloured Ribbon</span></p>
										 
										
			    					</div>
			    					<p class="bottom-area d-flex px-3">
		    							<a href="c1.php" class="add-to-cart text-center py-2 mr-1"><span>Select  <input type="checkbox" id="vehicle1" name="vehicle1" value="Bike"><i class=""></i></span></a>
		    			...
		    			<div class="col-sm-12 col-md-12 col-lg-4 ftco-animate d-flex">
		    				<div class="product d-flex flex-column">
		    					<a href="c2.php" class="img-prod"><img class="img-fluid" src="images/car2.jpg" alt="Colorlib Template">
		    					...
		    					<div class="text py-3 pb-4 px-3">
		    						...
		    						<h3><a href="c2.php"></a></h3>
		  							<div class="pricing">
			    						<p class="price"><span class="mr-2 price-dc"></span><span class="price-sale">3000Tk per hour</span></p>
										<p <span> Decorated with 200 Daliahs & Pink Coloured Ribbons</span></p>
										

			    					</div>
			    					<p class="bottom-area d-flex px-3">
		    							<a href="c2.php" class="add-to-cart text-center py-2 mr-1"><span>Select <input type="checkbox" id="vehicle2" name="vehicle2" value="Car"> <i class=""></i></span></a>
		    			...
		    			<div class="col-sm-12 col-md-12 col-lg-4 ftco-animate d-flex">
		    				<div class="product">
		    					<a href="c3.php" class="img-prod"><img class="img-fluid" src="images/car3.jpg" alt="Colorlib Template">
			    					<div class="overlay"></div>
			    				</a>
		    					<div class="text py-3 pb-4 px-3">
		    						<div class="d-flex">
		    						...
		    						<h3><a href="c3.php"></a></h3>
		  							<div class="pricing">
			    						<p class="price"><span>2000Tk per hour</span></p>
										<p <span> Decorated with 150 Red & White Roses </span></p>
										 

			    					</div>
			    					<p class="bottom-area d-flex px-3">
		    							<a href="c3.php" class="add-to-cart text-center py-2 mr-1"><span>Select <input type="checkbox" id="vehicle3" name="vehicle3" value="Boat"><i class=""></i></span></a>
